...
export const STATIC_FILES = [
  ...
  'experience.js', 'experience-math.js', 'experience.css', 'snapshot-client.js',
  'favicon.svg', 'apple-touch-icon.png', 'og-image.png'
];
export const VERSIONED_ASSETS = [...STATIC_FILES.filter(name => name !== 'index.html' && name !== 'og-image.png'), 'deployment.js'];
